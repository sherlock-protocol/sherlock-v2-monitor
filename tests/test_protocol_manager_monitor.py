...
class ProtocolManagerMonitorTests(TestCase):
    ...
    @mock.patch("monitors.protocol_manager.ProtocolManagerMonitor.get_protocol_balance", return_value=100_000_000)
    ...
    @mock.patch("monitors.protocol_manager.ProtocolManagerMonitor.get_protocol_balance", return_value=999)
    ...
    @mock.patch("monitors.protocol_manager.ProtocolManagerMonitor.get_protocol_balance", side_effect=[100_000_000, 999])
